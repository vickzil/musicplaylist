<template>
  <div class="show_playing_music" :class="(showPlayingMusics) ? 'showPlaying' : '' ">
    <div class="music_playing_container">
      ...
      <div class="middle_icons" @click="hideCurrentSongProperties">
        <div class="middle_icons_container">
          <i class="fa fa-music" :class="(isPlaying) ? 'rotateplayingIcon' : '' "></i>
        </div>
      </div>
      <div class="playing_volume">
        <div class="volume_inline">
          <span
            class="volume_icon"
            :class="(volume == 0) ? 'addVisibility': 'removeVisibility'"
            style="font-size: 11px; display: inline; padding-right: 5px"
          >Mute</span>
      ...
      <div class="music_bottom_control">
        <div class="music_playing_title" title="Song Title">{{current.title}}</div>
      ...
      <div class="music_propertise" v-if="revealProperties">
        <div class="propertise_container">
          ...
          <p>
            ...
            <br />
            <span v-for="artist in current.artist" :key="artist" class="artist_name">{{artist}}</span>
          </p>
          <p>
          ...
          <p class="removePropertise" @click="hideCurrentSongProperties">OK</p>
        </div>
      </div>
      ...
      <div class="add_play_list" v-if="showPlayingSongPropertises">
        <div class="playlist_icons" @click="addAsFavourite">
          ...
          <span>{{(getFavouriteColor) ? 'Remove from favourite' : 'Add to favourite'}}</span>
        </div>
        <a
          :href="current.src"
        ...
        <div class="playlist_icons showProperTise" @click="showCurrentSongProperties">
